...
const BalanceStaticCard: React.FC = () => {
  const [state, setState] = useState<BalanceStaticState>({
    series: [
      {
        name: "Sales",
        data: [44, 55, 41, 67, 22],
        ...
        <div className="flex flex-col flex-grow h-full w-35">
          <div className="flex flex-col h-full">
            <div className="flex h-full">
              <h4 className="text-title-lg font-bold">$564</h4>
            </div>
            <div className="flex gap-2 h-full">
              <Image
                ...
                height={35}
              />
              <h4 className="text-sm">Your total balance</h4>
            </div>
          </div>
          <div className="flex flex-col h-full w-full">
            <div className="flex justify-center items-center h-15 m-0 p-0">
              <ReactApexChart
...
export default BalanceStaticCard;
